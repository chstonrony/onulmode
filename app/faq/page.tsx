...
const FAQ_LIST = [
  ...
  {
    q: "감정 기록은 어떻게 시작하면 되나요?",
    a: "가장 쉬운 방법은 '감정 파쇄하기' 페이지에서 오늘 있었던 감정을 한 줄만 적어 던지는 거예요. 길게 쓰지 않아도 돼요. 단어 하나, 짧은 문장 하나로도 충분해요. 감정에 이름을 붙이는 것만으로도 달라지는 게 있어요.",
  },
  {
    q: "감정 기록을 매일 해야 하나요?",
    a: "매일 하면 좋지만, 그럴 필요는 없어요. 힘든 날, 감정이 올라오는 날, 또는 뭔가 남기고 싶은 날에만 와도 충분해요. 규칙적으로 해야 한다는 압박 없이, 필요할 때 오는 공간으로 사용해주세요.",
  },
  {
    q: "감정 퇴비화 결과는 무슨 의미인가요?",
    a: "퇴비화 결과는 내가 느낀 감정의 '뿌리'를 보여주려는 거예요. 예를 들어 서운함의 뿌리에는 '기대'가 있을 수 있고, 질투의 뿌리에는 '원함'이 있을 수 있어요. 교훈이나 긍정적인 해석이 아니라, 감정의 원인을 가볍게 발견하는 용도예요.",
  },
  {
    q: "오늘무드와 오늘눈치는 어떻게 다른가요?",
    a: "오늘무드는 나의 감정을 기록하고 정리하는 서비스예요. 오늘눈치는 분위기와 사회적 감각에 관한 별도 서비스로, 오늘무드와 같은 팀에서 만들었지만 다른 주제를 다뤄요. 두 서비스는 독립적으로 운영됩니다.",
  },
  {
    q: "감정파쇄 결과가 매번 다른 이유는?",
    a: "오늘무드의 결과는 입력한 감정 키워드, 선택한 처리 방식, 시드값을 조합해 생성돼요. 같은 감정을 넣어도 매번 다른 결과가 나올 수 있어요. 이건 의도적인 것으로, 결과 자체보다 감정을 꺼내는 경험에 집중하기 위해서예요.",
  },
  {
    q: "오늘무드는 상담 서비스인가요?",
    a: "아닙니다. 오늘무드는 감정 콘텐츠 서비스예요. 상담사가 없고, 전문적인 심리 지원도 제공하지 않아요. 가볍게 감정을 꺼내고, 기록하고, 우걱이와 함께 조금 웃기게 정리해보는 서비스예요. 심각한 심리적 어려움이 있다면 전문 상담을 권장해요.",
  },
  {
    q: "결과는 저장되나요?",
    a: "네, 다만 서버가 아니라 사용자의 브라우저(로컬 저장소)에만 저장돼요. 오늘무드는 별도의 회원가입이나 로그인이 없어서, 기록은 사용 중인 기기에만 남습니다. 그래서 브라우저 데이터를 지우거나 다른 기기로 접속하면 이전 기록은 보이지 않아요. 개인 감정 기록을 외부로 보내지 않는 구조라, 마음 편히 적어도 됩니다.",
  },
  {
    q: "모바일에서도 이용 가능한가요?",
    a: "네, 오늘무드는 모바일 환경을 우선으로 만들어졌어요. 스마트폰 브라우저에서 바로 이용할 수 있고, 별도 앱 설치 없이 onulmood.com 에 접속하면 됩니다. 화면이 작은 기기에서도 감정 기록, 결과 확인, 감정 아카이브를 편하게 볼 수 있도록 디자인했어요.",
  },
  {
    q: "오늘무드는 누가 만들었나요?",
    a: "오늘무드는 청소년의 회복과 성장을 돕는 디렉터, 최샤론 목사가 만들었습니다. 마음이 지친 사람들 곁에 오래 있으면서, 감정을 억지로 없애기보다 잠시 가볍게 내려놓도록 돕고 싶다는 마음에서 시작된 서비스예요. 운영자에 대한 더 자세한 이야기는 소개 페이지에서 볼 수 있어요.",
  },
  {
    q: "광고가 표시되는 이유는 무엇인가요?",
    a: "오늘무드는 누구나 무료로 이용할 수 있도록 만들어졌어요. 서비스를 유지하고 콘텐츠를 계속 만들어가기 위한 최소한의 운영 비용을 광고로 충당합니다. 광고는 콘텐츠를 가리거나 이용을 방해하지 않는 선에서 노출되며, 광고 수익은 서비스 운영과 콘텐츠 제작에 쓰입니다.",
  },
];
