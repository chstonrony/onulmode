...
// ─── 결과 등급 ────────────────────────────────────────────
const GRADES = [
  { text: "파쇄 완료",       sub: "오늘치 처리됨" },
  { text: "감정 찌꺼기 남음", sub: "부분 파쇄 완료" },
  { text: "재투입 권장",     sub: "내일 다시 오세요" },
  { text: "오늘은 그냥 누워있기", sub: "처방 완료" },
  { text: "완전 분해",       sub: "잘 갈렸음" },
  { text: "강제 처리됨",     sub: "질겼지만 완료" },
  { text: "위험 감정 제거",  sub: "주변 보호 완료" },
] as const;
